<template>
    <table class="table">
        ...
        <tbody>
            ...
            <tr class="baff">
                <td>77</td>
                <td>Бессмертие на 1 мин.</td>
            </tr>
            <tr class="baff">
                <td>88</td>
                <td>Скорость падения снижена</td>
            </tr>
            <tr class="baff">
                <td>123</td>
                <td>Увеличена скорость бега</td>
            </tr>
            <tr class="baff">
                <td>211</td>
                <td>Увеличена сила и ловкость</td>
            </tr>
            ...
            <tr class="debaff">
                <td>222</td>
                <td>Уменьшение силы и ловкости</td>
            </tr>
            <tr class="debaff">
                <td>255</td>
                <td>Напоить героя</td>
            ...
            <tr class="npc">
                <td>210</td>
                <td>Отправь рандомный подарок герою курьером. Ещё он передаст сообщение из доната</td>
            </tr>
            <tr class="npc">
                <td>333</td>
                <td>Задай вопрос в донате, нейросеть его обработает и пришлёт в игре Оракула с ответом!</td>
            </tr>
            <tr class="npc">
                <td>404</td>
                <td>Напишите в донате совет, нейросеть сгенерирует несколько фраз на его основе и отправит назойливого советчика преследовать героя
                </td>
            </tr>
            <tr class="npc">
                <td>555</td>
                <td>Придумай персонажа, опиши его. Он придёт на помощь герою и расскажет свою историю, доработанную с помощью
                    нейросети!
                </td>
            </tr>
            <tr class="npc">
                <td>666</td>
                <td>Найми убийцу и отправь его за героем! Не забудь в донате написать сообщение, убийца его передаст</td>
            </tr>
            ...
            <tr class="special">
                <td>155</td>
                <td>Герой превращается в факира</td>
            </tr>
            <tr class="special">
                <td>170</td>
            ...
            <tr class="special">
                <td>260</td>
                <td>Герой становится в меру упитанный</td>
            </tr>
            <tr class="special">
                <td>266</td>
            ...
            <tr class="trigger">
                <td>2000</td>
                <td>Немедленная смерть героя</td>
            </tr>
